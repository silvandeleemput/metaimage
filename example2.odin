/* Advanced example code for using the the MetaImage Odin package
*
* This is a more advanced example for how to use the MetaImage library
*
* This example:
*   1. Reads an MetaIO image (by default from the provided test input files)
*   2. Writes it to another location (by default to `output_image_002.mha`)
*   3. Reads the written image and displays compression rate
*
*   - It provides options to pass the input and output files as command line arguments
*   - It times steps 1, 2, and 3
*   - It removes the final written image
*/
...
main :: proc()
{
    ...
    output_image_filepath := `./output_image_002.mha`
